...
public class ArchitectureTest {
    ...
    void shouldRespectHexagonalLayeredArchitecture() {
        Architectures.LayeredArchitecture rule = Architectures.layeredArchitecture()
                ...
                .layer("Mapper").definedBy("..application.mapper..")
                .layer("DTO").definedBy("..application.dto..")
                .layer("Domain").definedBy("..domain..")
                .layer("Ports").definedBy("..domain.ports..")
                .layer("Infrastructure").definedBy("..infrastructure..")

                .whereLayer("Controller").mayOnlyAccessLayers("ServiceApp", "DTO", "Mapper", "Domain")
    ...
    void shouldHaveNoCyclicDependencies() {
        ArchRule rule = slices().matching("com.tfg.auth.(*)..")
    ...
    /**
     * Ensures domain model does not depend on Jakarta or Spring.
     */
    @Test
    void domainShouldBeFreeOfSpringAndJakarta() {
        ArchRule rule = classes()
